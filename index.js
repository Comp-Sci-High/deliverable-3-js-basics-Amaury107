...
let greeting1 = "hello my name is " + fname
...
favoriteMovie.quote ="Tonight we steel the moon !"
...
console.log ("my favorite movie is " + favoriteMovie.Name+ " the genre is " + favoriteMovie.genre + " i give a rating of " + favoriteMovie.rating + " a qoute i find nice is "+ favoriteMovie.quote)
